using System;
using MultilanguageJHipsterDotNet.Infrastructure.Configuration;
using System.IdentityModel.Tokens.Jwt;
using System.Text;
using MultilanguageJHipsterDotNet.Infrastructure.Data;
using MultilanguageJHipsterDotNet.Domain;
using MultilanguageJHipsterDotNet.Security;
using MultilanguageJHipsterDotNet.Security.Jwt;
using MultilanguageJHipsterDotNet.Domain.Services;
using MultilanguageJHipsterDotNet.Domain.Services.Interfaces;
...
using AuthenticationService = MultilanguageJHipsterDotNet.Domain.Services.AuthenticationService;
using IAuthenticationService = MultilanguageJHipsterDotNet.Domain.Services.Interfaces.IAuthenticationService;
