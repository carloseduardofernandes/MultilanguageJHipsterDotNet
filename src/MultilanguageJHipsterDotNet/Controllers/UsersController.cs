...
using MultilanguageJHipsterDotNet.Dto;
using MultilanguageJHipsterDotNet.Web.Extensions;
using MultilanguageJHipsterDotNet.Web.Filters;
using MultilanguageJHipsterDotNet.Web.Rest.Problems;
using MultilanguageJHipsterDotNet.Web.Rest.Utilities;
...
namespace MultilanguageJHipsterDotNet.Controllers
{
    [Authorize]
