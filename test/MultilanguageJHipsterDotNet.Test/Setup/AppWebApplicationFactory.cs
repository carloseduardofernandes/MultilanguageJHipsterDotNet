...
using MultilanguageJHipsterDotNet.Test.Configuration;
...
namespace MultilanguageJHipsterDotNet.Test.Setup
{
        ...
        where TEntryPoint : class
    {
        ...
        {
            builder
                .UseSolutionRelativeContentRoot("src/MultilanguageJHipsterDotNet")
